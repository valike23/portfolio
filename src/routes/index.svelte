          ...
          <div class="categories-grid wow fadeInLeft">
            <nav class="categories">
              <ul class="portfolio_filter">
                ...
                <li><a href="#" data-filter=".wordpress">C# apps</a></li>
              ...
              <a id="demo07" class="portfolio_item">
                ...
                <div class="portfolio_item_hover">
                  <div class="portfolio-border clearfix">
                    <div class="item_info">
                      <span>Agrify</span>
                      <em>A modern way to trade agricultural products</em>
                    </div>
                  </div>
                </div>
              </a>
...
>
  <div class="container c-section">
    <div class="col-md-12">
      ...
      <a class="email-link" href="mailto:ludike23@gmail.com">Say Hello</a>
